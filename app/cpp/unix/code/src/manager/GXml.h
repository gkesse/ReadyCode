...
public:
    ...
    bool createXNode(const std::string& _path, const std::string& _value = "", bool _isCData = false, bool _isGet = true, bool _isCreate = false);
    bool createRNode(const std::string& _path, const std::string& _value = "", bool _isCData = false);
    bool createCXNode(const std::string& _path, const std::string& _value = "", bool _isCData = false);
    bool createCRNode(const std::string& _path, const std::string& _value = "", bool _isCData = false);
