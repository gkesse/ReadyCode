...
public:
    ...
    bool createRequest(const GString2& _module, const GString2& _method);

    bool loadData(const GString2& _data);
    ...
    bool getData(const GString2& _code, std::vector<GObject2*>& _map, GObject2* _obj);
