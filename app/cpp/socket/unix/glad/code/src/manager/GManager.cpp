...
GManager::GManager() {
    ...
    mgr->app->shader_vertex_file = "/home/rpi4/Programs/ReadyData/data/shader/wave.vs";
    mgr->app->shader_fragment_file = "/home/rpi4/Programs/ReadyData/data/shader/wave.fs";
